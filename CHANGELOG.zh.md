...
- **huawei-cloud-billing-scout**：仓库版本号回归 `2.3.x`；精简
  `SKILL.md`、`catalog.yml` 与本体头部（约 1% 降噪）；语义、事实表输出与 21 条 eval 不变

## 1.0.5 - 2026-05-23

### 变更

- **huawei-cloud-billing-scout**：精简 `SKILL.md`、`catalog.yml` 与本体头部文案（约 1%
  降噪）；语义、输出合同与 21 条 eval 不变
