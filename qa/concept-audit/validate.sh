...
SKILL_DIR="$(cd "$QA_DIR/../../skills/concept-audit" && pwd)"
...
check_skill_layout() {
  ...
  rg -q '^name: concept-audit$' "$SKILL_DIR/SKILL.md" || fail "frontmatter name mismatch"
...
printf 'OK: concept-audit validation passed\n'
