...
- Output shape (B2 / FinOps one-page): authoritative rules in `skills/.../SKILL.md` **输出合同**; machine-gradable checks in `evals/llm-rubric.yml` `global_assertions` (merged into every eval case).
